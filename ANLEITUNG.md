# So erstellst du deinen Post 💛

Diese Anleitung zeigt dir Schritt für Schritt, wie du mit **Insta-Studio**
einen schönen Instagram-Post gestaltest. Du brauchst nur dein Handy – und
etwa 5 Minuten.

## Einmalig: Die App auf deinen Startbildschirm holen

1. Öffne den Link zur App in deinem Handy-Browser (Safari oder Chrome).
2. Tippe auf **Teilen** (das Viereck mit dem Pfeil nach oben).
3. Wähle **„Zum Home-Bildschirm“**.

Jetzt liegt Insta-Studio wie eine normale App auf deinem Handy – und
funktioniert sogar ohne Internet.

## Schritt 1: Format wählen 🎨

- **Quadrat** – der klassische Instagram-Beitrag
- **Hochformat** – etwas größer im Feed (meist die beste Wahl)
- **Story** – füllt den ganzen Bildschirm
...
Tippe auf **„Bild speichern“**. Dein Handy fragt dich, wohin – wähle
**„Bild sichern“** oder deine Fotos-App. Das Bild wird in voller Qualität
gespeichert.
